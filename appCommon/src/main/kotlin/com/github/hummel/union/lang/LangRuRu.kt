	...
	override fun getJson(): String = """
		{
			...
			"duck_long": "Ответ слишком длинный и превышает лимит Discord. Попробуйте отредактировать промпт на манер «Напиши 3 абзаца».",
			"duck_off": "Сайт с нейросетью временно не работает, либо перегружен, либо правила запросов изменились, и теперь требуется обновление программы бота.",
