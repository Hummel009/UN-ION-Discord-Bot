	...
	override fun getJson(): String = """
		{
			...
			"duck_long": "Відповідь надто довга та перевищує ліміт Discord. Поспробуйте відредагувати промпт на зразок «Напиші 3 абзаци».",
			"duck_off": "Сайт із нейромережею тимчасово не працює, або перевантажений, або змінилися правила запитів, і тепер вимагається оновлення програми боту.",
