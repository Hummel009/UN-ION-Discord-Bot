	...
	val JSON: String = """
		{
			...
			"ADDED_MANAGER": "Manager role has been added: %s.",
			"ADDED_CHANNEL": "Secret channel has been added: %s.",
			"ADDED_BIRTHDAY": "Birthday has been added: %s, %d.%d.%d.",
			"REMOVED_MANAGER": "Manager role has been removed: %s.",
			"REMOVED_CHANNEL": "Secret channel has been removed: %s.",
			"REMOVED_BIRTHDAY": "Birthday has been removed: %s.",
