	...
	override fun getJson(): String = """
		{
			...
			"duck_long": "Адказ занадта доўгі і перавышае мяжу Discord. Паспрабуйце адрэгадаваць промпт на кшталт «Напішы 3 абзацы».",
			"duck_off": "Сайт з нейрасецівам тэрмінова адключаны, альбо перавантажаны, альбо правілы запытаў змяніліся, і цяпер патрабуецца абнаўленне прыкладання бота.",
