...
enum class Lang(private val ru: String, private val en: String) {
	...
	BACKUP_ERROR("Ошибка при копировании и отправке файла.", "Error when copying and sending a file."),
	...
	SET_LANGUAGE("Установить язык", "Set language"),
	SET_CHANCE("Установить шанс", "Set chance"),
